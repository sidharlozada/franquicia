...
$estad = $estadistica->getMercadeo($conn, $fechaAct, $fechaInicio, $fechaFinal);
...
/*****************************************************************************/
   ...
   <div class="container-fluid">
      ...
      <div class="d-sm-flex align-items-center justify-content-between mb-4 mt-3">
         <h1 class="h3 mb-0 text-gray-800">Estadísticas de Mercadeo</h1>
      </div>
            ...
            <div class="card border-left-primary shadow h-100 py-2">
               <div class="card-body">
                  <div class="row no-gutters align-items-center">
                     <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Numero de Clientes Contactados (Mensual)</div>
         ...
         <div class="col-xl-6 col-md-6 mb-4">
            <div class="card border-left-success shadow h-100 py-2">
               <div class="card-body">
                  <div class="row no-gutters align-items-center">
                     <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Clientes Contactados (Diario)</div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800">
                           <?=($estad->id);?>
                        </div>
                     </div>
         ...
         <!-- <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-warning shadow h-100 py-2">
               <div class="card-body">
                  <div class="row no-gutters align-items-center">
                     <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Total de Ventas Diario (Bs.)</div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800">
                           <?=muestrafloat($estad->bs);?>
                        </div>
                     </div>
                     <div class="col-auto">
         ...
         <!-- <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-warning shadow h-100 py-2">
               <div class="card-body">
                  <div class="row no-gutters align-items-center">
                     <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Total de Ventas Diario ($.)</div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800">
                           <?=muestrafloat($estad->dolar);?>
                        </div>
                     </div>
                     <div class="col-auto">
         ...
         <div class="col-xl-12 col-lg-7">
            <div class="card shadow mb-4">
               ...
               <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Gráfica de Clientes Contactados Mensual</h6>
            ...
            <!-- Card Body -->
            <div class="card-body">Total de Clientes Contactados: <?=muestrafloat($total)?>
      ...
      <div class="col-xl-6 col-lg-7">
        <div class="card shadow mb-4">
          ...
          <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Respuestas Mas Comunes Recibidas (Diario)</h6>
          </div>
      ...
      <div class="col-xl-6 col-lg-7">
        <div class="card shadow mb-4">
          ...
          <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Respuestas Mas Comunes Recibidas (Mensual)</h6>
          </div>
