...
<? if($opcion=="1"){ ?>
   ...
   <div class="modal-header">
      <h5 class="modal-title" id="exampleModalLabel"><b>Buscar Facturas</b></h5>
         ...
         <div class="col-sm-3">
            <div class="input-group inner-addon right-addon">
               <label>
                  ...
                  <input class="form-control input-sm" type="text" name="codigo2" id="codigo2" onkeyup="buscaPopup(<?=$pagina?>);">
...
function buscaPopup(nro){
 ...
 // setTimeout(function(){
  ...
  $(muestra).load("buscaFactura.php", {descripcion:$('#descripcion2').val(),codigo:$('#codigo2').val(),pagina:nro});
 // }, 1000);
