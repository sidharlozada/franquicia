...
<link rel="icon" href="img/favicon.png">
    <title>CG Software - Sistema</title>
<div class="moon"></div>
...
<div class="error">
  ...
  <div class="error__subtitle">Servidor No Encontrado</div>
  <div class="error__description">Puede que tu licencia ya no sea valida!</div>
  <button class="error__button error__button--active">Contacto</button>
