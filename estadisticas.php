...
$estad = $estadistica->get($conn, $fechaAct, $fechaInicio, $fechaFinal);
...
/*****************************************************************************/
   ...
   <div class="container-fluid">
      ...
      <div class="d-sm-flex align-items-center justify-content-between mb-4 mt-3">
         <h1 class="h3 mb-0 text-gray-800">Estadísticas de Venta</h1>
      </div>
            ...
            <div class="card border-left-primary shadow h-100 py-2">
               <div class="card-body">
                  <div class="row no-gutters align-items-center">
                     <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Litros Vendidos (Diarios)</div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800">
                           <?=muestrafloat($estad->litros);?>
                        </div>
                     </div>
                     <div class="col-auto">
         ...
         <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-success shadow h-100 py-2">
               <div class="card-body">
                  <div class="row no-gutters align-items-center">
                     <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Facturas o Notas Diarias</div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800">
                           <?=($estad->cantidad);?>
                        </div>
                     </div>
         ...
         <div class="col-xl-6 col-lg-7">
            <div class="card shadow mb-4">
               ...
               <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Gráfica de Litros Vendidos</h6>
            ...
            <!-- Card Body -->
            <div class="card-body">Total litros: <?=muestrafloat($total)?>
