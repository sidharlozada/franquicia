...
$estad = $estadistica->getSistemas($conn, $fechaAct, $fechaInicio, $fechaFinal);
...
/*****************************************************************************/
   ...
   <div class="container-fluid">
      ...
      <div class="d-sm-flex align-items-center justify-content-between mb-4 mt-3">
         <h1 class="h3 mb-0 text-gray-800">Estadísticas del Departamento de Sistemas</h1>
      </div>
            ...
            <div class="card border-left-primary shadow h-100 py-2">
               <div class="card-body">
                  <div class="row no-gutters align-items-center">
                     <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Tickets Recibidos (Mensual)</div>
         ...
         <div class="col-xl-6 col-md-6 mb-4">
            <div class="card border-left-success shadow h-100 py-2">
               <div class="card-body">
                  <div class="row no-gutters align-items-center">
                     <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Tickets Recibidos (Diario)</div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800">
                           <?=($estad->id);?>
                        </div>
                     </div>
         ...
         <div class="col-xl-6 col-lg-4">
            <div class="card shadow mb-4">
               ...
               <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Gráfica de Tickets Recibidos Mensual</h6>
            ...
            <!-- Card Body -->
            <div class="card-body">Total de Tickets Recibidos: <?=muestrafloat($total)?>
      ...
      <div class="col-xl-6 col-lg-7">
        <div class="card shadow mb-4">
          ...
          <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Estatus de los Tickets (Mensual)</h6>
          </div>
      ...
      <div class="col-xl-6 col-lg-7">
        <div class="card shadow mb-4">
          ...
          <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Categorias de Tickets mas Usados (Diario)</h6>
          </div>
      ...
      <div class="col-xl-6 col-lg-7">
        <div class="card shadow mb-4">
          ...
          <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Categorias de Tickets mas Usados (Mensual)</h6>
          </div>
